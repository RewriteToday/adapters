...
Official integration of **Rewrite** with **edge runtimes** to receive **Webhooks** in a simple, secure and fully typed way.

[`@rewritetoday/edge`](https://www.npmjs.com/package/@rewritetoday/edge) is a **runtime-first** package, designed to work natively with the standard `Request` and `Response` APIs, focused on **DX**, **TypeScript first** and **good security practices**.

You can find the full Webhooks documentation [here](https://docs.rewritetoday.com).

<img src="https://cdn.rewritetoday.com/assets/banners/edge_banner.png" width="100%" alt="Rewrite Banner"/>
...
No extra dependencies are needed. The package is ready to use with the standard Web APIs available in edge runtimes.
